...
function OrderScreen() {
    const now = new Date();
    const formattedDate = format(now, "EEEE dd MMMM yyyy 'à' HH:mm");
   ...
   const dateOrder= (paymentResult)=>{
    order.isPaid= "true"
    order.paidAt = formattedDate
                                ...
                                <ListGroup.Item>
                                    ...
                                    <ListGroup.Item>
                                        {loadingPay && <Loader />}
                                            ...
                                            <Button style={ {backgroundColor: 'rgb(60, 60, 60)', border: '2px solid rgb(60, 60, 60)',}}  type='submit' variant='primary' onClick={dateOrder}>
            Place Order
        </Button>
